...
--    ╚══╝     ╚═╝  ╚═╝ ╚═╝   ╚═╝     ╚═╝    ╚══════╝  ╚═════╝ ╚═╝  ╚═╝
--
-- Custom xmonad.hs minimal file for JaxTechOS
...
------------ My Preferred Apps
myTerminal           = "alacritty"        -- terminals (gnome-terminal, xterm, alacritty)
myFileManager        = "nemo"             -- file managers (pcmanfm, lf, nemo, thunar)
myBrowser            = "firefox"          -- web browsers (firefox, falkon)
myMusicPlayer        = "rhythmbox"        -- music player (rhythmbox, ncmpcpp, "alacritty -e cmus")
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
  ...
  --(MOD+SHIFT+<KEY>) ----------------------------------------------------------------------------------------------
  [ ((modm .|. shiftMask, xK_b     ), spawn (myBrowser))                                     -- Launch Preferred Web Browser
  , ((modm .|. shiftMask, xK_c     ), kill)                                                  -- Close focused window
  , ((modm .|. shiftMask, xK_d     ), spawn "dmenu_run")                                     -- Launch dmenu Run
  , ((modm .|. shiftMask, xK_f     ), spawn (myFileManager))                                 -- Launch Preferred File Manager
  , ((modm .|. shiftMask, xK_j     ), windows W.swapDown  )                                  -- Swap the focused window with the next window
  , ((modm .|. shiftMask, xK_k     ), windows W.swapUp    )                                  -- Swap the focused window with the previous window
  , ((modm .|. shiftMask, xK_m     ), spawn (myMusicPlayer))                                 -- Launch Preferred Music Player
  ...
  , ((modm .|. shiftMask, xK_t     ), spawn (myTerminal))                                    -- Launch Preferred Terminal
